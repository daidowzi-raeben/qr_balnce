...
$sql_common = " from qr_member_student ";
...
?>
<div>
    <form method="post" enctype="multipart/form-data" action="./member_student_excel.php">
        <label for="file">업로드 파일 선택</label>
        <input type="file" id="file" name="file" accept=".xlsx,.csv" required>

        <div style="margin-top:20px">
            <button class="btn" type="submit">업로드 실행</button>
        </div>
    </form>
</div>
...
<form id="fsearch" name="fsearch" class="local_sch01 local_sch" method="get">
    ...
    <select name="sfl" id="sfl">
        ...
        <option value="mb_1" <?php echo get_selected($sfl, "mb_1"); ?>>분야</option>
        <option value="mb_company" <?php echo get_selected($sfl, "mb_company"); ?>>소속</option>
        <option value="mb_year" <?php echo get_selected($sfl, "mb_year"); ?>>년도</option>
        <option value="c_datetime" <?php echo get_selected($sfl, "c_datetime"); ?>>가입일시</option>
    </select>
...
<form name="fmemberlist" id="fmemberlist" action="./member_list_update.php" onsubmit="return fmemberlist_submit(this);"
        ...
        <table>
            ...
            <thead>
                ...
                <tr>
                    ...
                    <th scope="col" id="mb_list_name"><?php echo subject_sort_link('mb_year') ?>년도</a></th>
                    <th scope="col" id="mb_list_nick"><?php echo subject_sort_link('mb_1') ?>분야</a></th>
                    <th scope="col" id="mb_list_deny"><?php echo subject_sort_link('mb_company', '', 'desc') ?>소속</a>
                    </th>
                    <th scope="col" id="mb_list_tel">이름</th>
                    <th scope="col" id="mb_list_join"><?php echo subject_sort_link('mb_id', '', 'desc') ?>사번</a>
                    </th>
                    <th scope="col" id="mb_list_point"><?php echo subject_sort_link('c_datetime', '', 'desc') ?>
                        등록일</a>
                    </th>
            ...
            <tbody>
                ...
                <tr class="<?php echo $bg; ?>">
                    ...
                    <td headers="mb_list_nick" class="td_name sv_use">
                        <div><?php echo $row['mb_year'] ?></div>
                    </td>
                    <td headers="mb_list_nick" class="td_name sv_use">
                        <div><?php echo $row['mb_1'] ?></div>
                    </td>
                    <td headers="mb_list_nick" class="td_name sv_use">
                        <div><?php echo $row['mb_company'] ?></div>
                    </td>
                    <td headers="mb_list_nick" class="td_name sv_use">
    ...
    <div class="btn_fixed_top">
        ...
        <a href="./member_student_form.php" id="member_add" class="btn btn_01">회원추가</a>
        <?php } ?>
