...
<form name="fmember" id="fmember" action="./cd.member_form_update.php" onsubmit="return fmember_submit(this);" method="post" enctype="multipart/form-data">
...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tbody>
	<tr>
        <th scope="row"><label for="mb_10">년도<?php echo $sound_only ?></label></th>
        <td>
            <input type="text" name="mb_10" value="<?php echo $mb['mb_10'] ?>" id="mb_10" class="frm_input" size="30" maxlength="20">
        </td>
      <th scope="row"><label for="mb_profile">회사명</label></th>
        <td>
		<input type="text" name="mb_profile" value="<?php echo $mb['mb_profile'] ?>" id="mb_profile" class="frm_input" size="30" maxlength="20">
	...
	<tr>
		<th scope="row"><label for="mb_3">부서1<?php echo $sound_only ?></label></th>
        <td>
			<input type="text" name="mb_3" value="<?php echo $mb['mb_3'] ?>" id="mb_3" class="frm_input" size="30" maxlength="20">
		</td>
        <th scope="row"><label for="mb_4">부서2<?php echo $sound_only ?></label></th>
        <td>
			<input type="text" name="mb_4" value="<?php echo $mb['mb_4'] ?>" id="mb_4" class="frm_input" size="30" maxlength="20">
        </td>
    </tr>
	<tr>
	  <th scope="row"><label for="mb_1">소속<?php echo $sound_only ?></label></th>
        <td>
			<input type="text" name="mb_1" value="<?php echo $mb['mb_1'] ?>" id="mb_1" class="frm_input" size="30" maxlength="20">
		</td>
	 
		<th scope="row"><label for="mb_8">학습기간<?php echo $sound_only ?></label></th>
        <td>
			<input type="text" name="mb_8" value="<?php echo $mb['mb_8'] ?>" id="mb_8" class="frm_input" size="30" maxlength="20">
			~
			<input type="text" name="mb_9" value="<?php echo $mb['mb_9'] ?>" id="mb_9" class="frm_input" size="30" maxlength="20">
		</td>
    </tr>
	<tr>
		<th scope="row"><label for="mb_5">직책<?php echo $sound_only ?></label></th>
        <td>
			<input type="text" name="mb_5" value="<?php echo $mb['mb_5'] ?>" id="mb_5" class="frm_input" size="30" maxlength="20">
		</td>
    ...
    <tr>
        ...
        <td><input type="text" name="mb_hp" value="<?php echo $mb['mb_hp'] ?>" id="mb_hp" class="frm_input" size="30" maxlength="20"></td>
    </tr>
	<tr>
