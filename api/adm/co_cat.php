...
$sql_common = " from cd_co_cate as m where (1) ";
...
<div class="local_ov02">
	...
	<div class="r_div">
		...
		<a href="./co_cat_w.php" class="btn btn_03">등록</a>
	</div>
</div>
<div>
    ...
    <div class="tbl_head01 tbl_wrap">
		...
		<input type="hidden" name="re" value="./co_cat.php">
		<input type="hidden" name="table" value="cd_co_cate">
        <table>
            ...
            <tr class="<?php echo $bg; ?>">
				...
				<td><a href="./co_cat_w.php?idx=<?php echo $row['idx']?>&w=u"><?php echo $row['cd_name']?></a></td>
