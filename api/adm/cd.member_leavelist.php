...
$sql_search = " where (1) ";
$sql_search .= " and mb_leave_date != '' and mb_level >= 0";
...
<form name="fmemberlist" id="fmemberlist" action="./member_leavelist_update.php" onsubmit="return fmemberlist_submit(this);" method="post">
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col" id="mb_list_no" width="100">No</a></th>
    ...
    <tr class="<?php echo $bg; ?>">
		...
		<td headers="mb_list_join" class="td_date"><?php echo date("y-m-d", strtotime($row['mb_leave_date'])); ?></td>
