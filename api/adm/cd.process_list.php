    ...
    <div class="local_ov02">
        ...
        <div class="r_div">
            <?php if ($is_admin == 'super') { ?>
                <a href="./cd.process_form.php?idx=<?php echo $_GET['idx']?>" id="member_add" class="btn btn_03">신규등록</a>
            <?php } ?>
        </div>
    </div>
    ...
    <div class="tbl_head01 tbl_wrap">
        <table>
            ...
            <tr>
                ...
                <th scope="col" id="cp_list_mng">차시등록</th>                
            ...
            <tr>
                ...
                <td class="cp_list_"><a href="./cd.process_class_list.php?idx=<?php echo $row['lssn_no']?>" id="lssn_mod" class="btn btn_03">차시등록</a></td>
				<td class="cp_list_"><a href="./cd.process_form.php?w=u&lno=<?php echo $row['lssn_no']?>" id="lssn_mod" class="btn btn_03">수정</a></td>
            </tr>
            <?php 
				$startNum++;
			} ?>
