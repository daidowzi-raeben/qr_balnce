...
WHERE cll.lssn_company = '".$company."' AND cll.lssn_kind = 'LS22'
...
<div class="local_ov02">
	...
	<div class="r_div">
		<?php if ($is_admin == 'super') { ?>
			<a href="./cd.learn_excel_down_m_1.php?kind=LS22&company=<?php echo $company?>&lssn=<?php echo $app_lssn_no?>&amp;sfl=<?php echo $sfl ?>&amp;str=1" target="_blank" id="member_add" class="btn btn_04">EXCEL</a>
		<?php } ?>
	</div>
</div>
<div>
...
function selectLocation(v) {
	console.log(v.value)
		location.href='./cd.learn_message_3_list.php?company='+v.value;
}
