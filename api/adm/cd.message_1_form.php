...
<div class="tbl_frm02 tbl_wrap">
    ...
    <form id="flesson" name="flesson" action="./cd.message_1_form_update.php" class="local_sch01 local_sch11" method="post" onsubmit="return flesson_submit(this);">
	...
	<input type="hidden" name="lno" value="<?php echo $lno ?>">
        ...
        <div class="sch_div">
            ...
            <a href="./cd.message_list1.php" class="btn btn_02">돌아가기</a>
        </div>
