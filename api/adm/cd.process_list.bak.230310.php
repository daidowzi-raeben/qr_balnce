...
$sql_search = " where (1) and lssn_kind = 'LS01' ";
if ($stx) {
    $sql_search .= " and ( ";
    switch ($sfl) {
        case 'mb_point' :
    ...
    <div class="local_ov02">
        ...
        <div class="r_div">
            <?php if ($is_admin == 'super') { ?>
                <a href="./cd.process_form.php" id="member_add" class="btn btn_03">신규등록</a>
            <?php } ?>
        </div>
    </div>
    ...
    <div class="tbl_head01 tbl_wrap">
        <table>
            ...
            <tr>
                ...
                <th scope="col" id="cp_list_id">차시수</th>
                <th scope="col" id="cp_list_id">수료조건</th>
                <th scope="col" id="cp_list_id">시험점수</th>
                <th scope="col" id="cp_list_mng">노출</th>
			...
			?>
            <tr>
                <td class="cp_list_">1</td>
                <td class="cp_list_ td_left">
					<a href="cd.process_info.php" class=" ">
						<?php echo $row['lssn_title']?>
					</a>
                </td>
                <td class="cp_list_"><?php echo $row['lssn_chap_cnt']?></td>
                <td class="cp_list_"><?php echo $row['lssn_completerate']?></td>
                <td class="cp_list_"><?php echo $row['lssn_quiz_point']?></td>
                <td class="cp_list_">노출</td>
