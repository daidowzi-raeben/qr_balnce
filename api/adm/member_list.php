...
<form id="fsearch" name="fsearch" class="local_sch01 local_sch" method="get">
    ...
    <select name="sfl" id="sfl">
        <option value="mb_id" <?php echo get_selected($sfl, "mb_id"); ?>>사번</option>
        <option value="mb_nick" <?php echo get_selected($sfl, "mb_nick"); ?>>닉네임</option>
        <option value="mb_name" <?php echo get_selected($sfl, "mb_name"); ?>>이름</option>
        <option value="mb_name" <?php echo get_selected($sfl, "mb_5"); ?>>분야</option>
        <option value="mb_name" <?php echo get_selected($sfl, "mb_6"); ?>>소속</option>
        <option value="mb_name" <?php echo get_selected($sfl, "mb_homepage"); ?>>년도</option>
        ...
        <table>
            ...
            <thead>
                ...
                <tr>
                    ...
                    <th scope="col" id="mb_list_name"><?php echo subject_sort_link('mb_homepage') ?>년도</a></th>
                    <th scope="col" id="mb_list_nick"><?php echo subject_sort_link('mb_5') ?>분야</a></th>
                    <th scope="col" id="mb_list_deny"><?php echo subject_sort_link('mb_6', '', 'desc') ?>소속</a></th>
                    <th scope="col" id="mb_list_tel">이름</th>
                    <th scope="col" id="mb_list_join"><?php echo subject_sort_link('mb_id', '', 'desc') ?>사번</a>
                    </th>
                    <th scope="col" id="mb_list_point"><?php echo subject_sort_link('mb_datetime', '', 'desc') ?>
                        등록일</a>
                    </th>
                    <th scope="col" id="mb_list_point"> 관리
                    </th>
                </tr>
            </thead>
            <tbody>
                ...
                <!-- <tr class="<?php echo $bg; ?>">
                    ...
                    <td headers="mb_list_cert" rowspan="2" class="td_mbcert">
                        <input type="radio" name="mb_certify[<?php echo $i; ?>]" value="simple"
                            id="mb_certify_sa_<?php echo $i; ?>"
                            <?php echo $row['mb_certify'] == 'simple' ? 'checked' : ''; ?>>
                        <label for="mb_certify_sa_<?php echo $i; ?>">간편인증</label><br>
                        <input type="radio" name="mb_certify[<?php echo $i; ?>]" value="hp"
                            id="mb_certify_hp_<?php echo $i; ?>"
                            <?php echo $row['mb_certify'] == 'hp' ? 'checked' : ''; ?>>
                        <label for="mb_certify_hp_<?php echo $i; ?>">휴대폰</label><br>
                        <input type="radio" name="mb_certify[<?php echo $i; ?>]" value="ipin"
                            id="mb_certify_ipin_<?php echo $i; ?>"
                            <?php echo $row['mb_certify'] == 'ipin' ? 'checked' : ''; ?>>
                    ...
                    <td headers="mb_list_open">
                        ...
                        <input type="checkbox" name="mb_open[<?php echo $i; ?>]"
                            <?php echo $row['mb_open'] ? 'checked' : ''; ?> value="1" id="mb_open_<?php echo $i; ?>">
                    </td>
                    <td headers="mb_list_mailr">
                        <label for="mb_mailling_<?php echo $i; ?>" class="sound_only">메일수신</label>
                        <input type="checkbox" name="mb_mailling[<?php echo $i; ?>]"
                            <?php echo $row['mb_mailling'] ? 'checked' : ''; ?> value="1"
                            id="mb_mailling_<?php echo $i; ?>">
                    </td>
                    ...
                    <td headers="mb_list_mng" rowspan="2" class="td_mng td_mng_s">
                        <?php echo $s_mod ?><?php echo $s_grp ?></td>
                </tr> -->
                <tr class="<?php echo $bg; ?>">
                    ...
                    <td headers="mb_list_nick" class="td_name sv_use">
                        <div><?php echo $row['mb_homepage'] ?></div>
                    </td>
                    <td headers="mb_list_nick" class="td_name sv_use">
                        <div><?php echo $row['mb_5'] ?></div>
                    </td>
                    <td headers="mb_list_nick" class="td_name sv_use">
                        <div><?php echo $row['mb_6'] ?></div>
                    </td>
                    <td headers="mb_list_nick" class="td_name sv_use">
                        <div><?php echo $row['mb_name'] ?></div>
                    </td>
                    <td headers="mb_list_nick" class="td_name sv_use">
