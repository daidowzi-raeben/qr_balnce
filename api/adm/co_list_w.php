...
<div class="tbl_frm02 tbl_wrap">
	...
	<input type="hidden" name="mode" value="cd_co_cate4">
        <table>
...
$result_latest2 = sql_fetch($sql_latest2);
			...
			<tr>
			 ...
			 <tr>
                <th scope="row"><label for="lssn_year">과정주제<?php echo $sound_only ?></label></th>
                <td colspan="3">
                    <input type="text" class="new__input" name="cd_name" id="lssn_year" value="<?php echo $lssn['cd_name'] ?>" <?php echo $required_mb_id ?>  />
					(최근 등록 코드 : <?php echo $result_latest['cd_name']; ?>)
                </td>
            </tr>
			<tr>
                <th scope="row"><label for="lssn_sdate">과정등록관리 관리일</label></th>
                <td colspan="3">
			...
			<tr>
                ...
                <td colspan="3">
                    <input type="text" class="new__input width_185 datepicker" name="cd_dev_date" value="<?php echo $lssn['cd_dev_date'] ? $lssn['cd_dev_date'] : date("Y-m-d"); ?>" <?php echo $required_mb_id ?> />
                </td>
            </tr>
			 <tr>
			 ...
			 <tr>
                <th scope="row"><label for="lssn_year">과정파일 (미리보기)<?php echo $sound_only ?></label></th>
                <td colspan="3">
                    <input type="text" class="new__input" name="cd_file" id="lssn_year" value="<?php echo $lssn['cd_file'] ?>" <?php echo $required_mb_id ?>  />
					저장경로 : (contents/movie)
                </td>
            </tr>
			 <tr>
                <th scope="row"><label for="lssn_year">과정파일 경로<?php echo $sound_only ?></label></th>
                <td colspan="3">
                    <input type="text" class="new__input" name="cd_connect" id="lssn_year" value="<?php echo $lssn['cd_connect'] ?>" <?php echo $required_mb_id ?>  />
					저장경로 : (contents/movie)
                </td>
            </tr>
