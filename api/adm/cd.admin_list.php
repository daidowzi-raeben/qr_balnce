...
<div class="tbl_frm02 tbl_wrap">
    ...
    <tbody>
    <tr>
        <th scope="row"><label for="mb_year">회원소속</label></th>
        <td>
            <input type="text" name="mb_year" value="<?php echo $mb['mb_year'] ?>" id="mb_year" <?php echo $required_mb_year ?> class="frm_input" size="15"  maxlength="20">
        </td>
        <th scope="row"><label for="">상태</label></th>
        <td><input type="" name="" id="" <?php echo $required_mb_password ?> class="frm_input <?php echo $required_mb_password ?>" size="15" maxlength="20"></td>
    </tr>
	<tr>
		...
		<td colspan="3">
			...
			<select name="sfl" id="sfl">
				...
				<option value="mb_name"<?php echo get_selected($_GET['sfl'], "mb_name"); ?>>부서1</option>
				<option value="mb_name"<?php echo get_selected($_GET['sfl'], "mb_name"); ?>>부서2</option>
				<option value="mb_name"<?php echo get_selected($_GET['sfl'], "mb_name"); ?>>부서3</option>
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
		...
		<th scope="col" id="mb_list_id">이메일</a></th>
		<th scope="col" id="mb_list_id">메뉴권한</a></th>
		<th scope="col" id="mb_list_id">상태</a></th>
    ...
    <tr class="<?php echo $bg; ?>">
		...
		<td headers="mb_list_"><?php echo $row['mb_email'] ?></td>
