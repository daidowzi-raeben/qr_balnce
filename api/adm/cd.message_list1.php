...
$sql_search = " where (1) and lssn_kind = 'LS02' ";
if ($stx) {
    $sql_search .= " and ( ";
    switch ($sfl) {
        case 'mb_point' :
    ...
    <div class="local_ov02">
        ...
        <div class="r_div">
            <?php if ($is_admin == 'super') { ?>
                <a href="./cd.message_1_form.php?idx=<?php echo $_GET['idx']?>" id="member_add" class="btn btn_03">신규등록</a>
            <?php } ?>
        </div>
    </div>
    ...
    <div class="tbl_head01 tbl_wrap">
        <table>
            ...
            <tr>
				...
				<td class="cp_list_"><a href="./cd.message_1_form.php?w=u&lno=<?php echo $row['lssn_no']?>" id="lssn_mod" class="btn btn_03">수정</a></td>
            </tr>
            <?php 
				$startNum++;
			} ?>
