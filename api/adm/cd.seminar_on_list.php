...
$sql_search = " where (1) and lssn_kind = 'LS04' ";
if ($stx) {
    $sql_search .= " and ( ";
    switch ($sfl) {
        case 'mb_point' :
    ...
    <div class="local_ov02">
        ...
        <div class="r_div">
            <?php if ($is_admin == 'super') { ?>
                <a href="./cd.seminar_on_form.php" id="member_add" class="btn btn_03">신규등록</a>
            <?php } ?>
        </div>
    </div>
    ...
    <div class="tbl_head01 tbl_wrap">
        <table>
			...
			for ($i=0; $row=sql_fetch_array($result); $i++) {
				$s_mod = '<a href="./cd.seminar_on_form.php?'.$qstr.'&amp;w=u&amp;ls_no='.$row['lssn_no'].'" class="btn btn_03">수정</a>';
