...
@include_once('./'.$board['bo_skin'].'/view_comment.head.skin.php');
...
$comment_action_url = "./write_comment_update.php";

include_once('./'.$board['bo_skin'].'/view_comment.skin.php');

if (!$member['mb_id']) // 비회원일 경우에만
    echo '<script src="'.G5_JS_URL.'/md5.js"></script>'."\n";

@include_once('./'.$board['bo_skin'].'/view_comment.tail.skin.php');
?>