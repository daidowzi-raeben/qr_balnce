...
@include_once ('./'.$board['bo_skin'].'/write.head.skin.php');
...
switch($bo_table) {
	case "p_campaign":
		include_once ('./p_campaign/write.skin.php');
		break;
	default:
		include_once ('./basic/write.skin.php');
}

@include_once ('./'.$board['bo_skin'].'/write.tail.skin.php');
include_once(G5_ADMIN_PATH.'/cd.admin.tail.php');