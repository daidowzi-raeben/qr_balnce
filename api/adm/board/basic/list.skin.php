...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="btn_fixed_top">
       ...
       <button type="submit" name="btn_submit" value="선택복사" onclick="document.pressed=this.value" class="btn btn_02"><i class="fa fa-files-o" aria-hidden="true"></i> 선택복사</button>
       <button type="submit" name="btn_submit" value="선택이동" onclick="document.pressed=this.value" class="btn btn_02"><i class="fa fa-arrows" aria-hidden="true"></i> 선택이동</button>
        <?php } ?>
