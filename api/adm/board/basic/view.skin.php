...
add_stylesheet('<link rel="stylesheet" href="./basic/style.css">', 0);
?>
...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <div id="bo_v_top">
       ...
       <div class="btn_fixed_top">
            <?php if ($update_href) { ?><a href="<?php echo $update_href ?>" class="btn btn_02"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> 수정</a><?php } ?>
            <?php if ($delete_href) { ?><a href="<?php echo $delete_href ?>" class="btn btn_02" onclick="del(this.href); return false;"><i class="fa fa-trash-o" aria-hidden="true"></i> 삭제</a><?php } ?>
            <?php if ($copy_href) { ?><a href="<?php echo $copy_href ?>" class="btn btn_02" onclick="board_move(this.href); return false;"><i class="fa fa-files-o" aria-hidden="true"></i> 복사</a><?php } ?>
            <?php if ($move_href) { ?><a href="<?php echo $move_href ?>" class="btn btn_02" onclick="board_move(this.href); return false;"><i class="fa fa-arrows" aria-hidden="true"></i> 이동</a><?php } ?>
            <?php if ($search_href) { ?><a href="<?php echo $search_href ?>" class="btn btn_02"><i class="fa fa-search" aria-hidden="true"></i> 검색</a><?php } ?>
      
           
            <?php if ($reply_href) { ?><a href="<?php echo $reply_href ?>" class="btn btn_02"><i class="fa fa-reply" aria-hidden="true"></i> 답변</a><?php } ?>
