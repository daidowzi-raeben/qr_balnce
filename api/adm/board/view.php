...
@include_once('./'.$board['bo_skin'].'/view.head.skin.php');
...
//include_once('./'.$board['bo_skin'].'/view.skin.php');
include_once('./basic/view.skin.php');

@include_once('./'.$board['bo_skin'].'/view.tail.skin.php');
?>
