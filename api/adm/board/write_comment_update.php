...
@include_once('./'.$board['bo_skin'].'/write_comment_update.head.skin.php');
...
// 사용자 코드 실행
@include_once('./'.$board['bo_skin'].'/write_comment_update.skin.php');
@include_once('./'.$board['bo_skin'].'/write_comment_update.tail.skin.php');
