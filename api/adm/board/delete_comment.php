...
// 4.1
@include_once('./'.$board['bo_skin'].'/delete_comment.head.skin.php');
...
// 사용자 코드 실행
@include_once('./'.$board['bo_skin'].'/delete_comment.skin.php');
@include_once('./'.$board['bo_skin'].'/delete_comment.tail.skin.php');
