...
<div id="hd">
    ...
    <div id="tnb">
        <div class="inner">
            ...
            <ul id="hd_qnb">
                ...
                <li><a href="<?php echo G5_BBS_URL ?>/current_connect.php" class="visit">접속자<strong
                            class="visit-num"><?php echo connect('theme/basic'); // 현재 접속자수, 테마의 스킨을 사용하려면 스킨을 theme/basic 과 같이 지정  ?></strong></a>
                </li>
            </ul>
        </div>
    </div>
    <div id="hd_wrapper">
        ...
        <div id="logo">
            <a href="<?php echo G5_URL ?>"><span
                    style="color:#fff;font-size:20px;display:inline-block; margin-top:10px;">청렴 밸런스</span></a>
        </div>
        ...
        <ul class="hd_login">
            <?php if ($is_member) {  ?>
            <li><a
                    href="<?php echo G5_BBS_URL ?>/member_confirm.php?url=<?php echo G5_BBS_URL ?>/register_form.php">정보수정</a>
            </li>
        ...
        <div class="gnb_wrap">
            <ul id="gnb_1dul">
                ...
                <li class="gnb_2dli"><a href="<?php echo $row2['me_link']; ?>"
                        target="_<?php echo $row2['me_target']; ?>" class="gnb_2da"><?php echo $row2['me_name'] ?></a>
                </li>
                <?php
                    $k++;
                    }   //end foreach $row2
